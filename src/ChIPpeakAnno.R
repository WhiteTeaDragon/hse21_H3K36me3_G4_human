...
peaks <- toGRanges(paste0('exp.g4.intersection.bed'), format="BED")
peaks[1:2]
...
write.table(anno_df, file=paste0('exp.g4.intersection.genes.txt'),
            col.names = TRUE, row.names = FALSE, sep = '\t', quote = FALSE)

uniq_genes_df <- unique(anno_df['symbol'])
write.table(uniq_genes_df, file=paste0('exp.g4.intersection.genes_uniq.txt'),
